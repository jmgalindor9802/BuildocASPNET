...
namespace Buildoc.Services
{
    ...
    public class AzureBlobStorageService(IConfiguration configuration) : IAzureStorageService
    {
        private readonly string azureStorageConnectionString = configuration.GetValue<string>("AzureStorageConnectionString");
